...
- (void)CreatTable:(NSString *)table
{
    ...
    NSString *FmdbCreatFirstTable=@"CREATE TABLE IF NOT EXISTS backPhoneNumber(uuid INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT, number TEXT UNIQUE)";
...
{
    NSURL *containerURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:@"group.ForAdBlockGroup"];
