...
- (void)viewDidLoad {
    ...
    [self createNavWithTitle:@"照片瘦身" leftImage:@"Whiteback" rightImage:nil];
...
- (void)setupUI {
    ...
    optmizeBtn.backgroundColor = RGB(0, 166, 78);
    optmizeBtn.layer.masksToBounds = YES;
    optmizeBtn.layer.cornerRadius = 8;
