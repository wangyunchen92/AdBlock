...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.topViewHeightConstraint.constant = iPhoneX ? 88 : 64;
...
//    self.boardView.isShadow = YES;
    self.boardView.titleColorSelected = RGB(0, 166, 78);
    ...
    [self.boardView.view mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.view).with.offset(64 +  (iPhoneX ? 22 : 0) );
